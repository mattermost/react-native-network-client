...
class ClientListItem {
    ...
    getItemByName = (name) => {
        const itemMatcher = by.id(this.testID.item).withDescendant(by.text(name));

        return {
            item: element(itemMatcher),
            chevron: element(by.id(this.testID.chevron).withAncestor(itemMatcher)),
            content: element(by.id(this.testID.content).withAncestor(itemMatcher)),
            subtitle: element(by.id(this.testID.subtitle).withAncestor(itemMatcher)),
